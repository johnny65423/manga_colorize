...
rootpath = r"D:\DataSet\0718_sketch\img" # 測試圖片的路徑
#rootpath = r"E:\manga"
...
def saveallimg(model, data, testsize, save=True):
	...
	for i in range(testsize):
		...
		new_img1.convert('L').save("origin.jpg")
		...
		new_img2.convert('L').save("result/" + str(i) + ".jpg")

'''


def topath( image ) :
	image.save("D:/DataSet/0718_sketch/img/.imagetemp/sketch_temp.jpg")
	return rootpath + r"\.imagetemp\sketch_temp.jpg"



net_G = build_res_unet(n_input=1, n_output=1, size=256)
net_G.load_state_dict(torch.load(r"D:\DataSet\0718_sketch\img\res34-unet_forBlack.pt", map_location=device))
...
def sketchtograyscale(image):
	...
	matplotlib.image.imsave(".imagetemp/gray_temp.jpg", fake_imgs, cmap='gray')
	img2 = Image.open(".imagetemp/gray_temp.jpg")

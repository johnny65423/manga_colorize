...
rootpath = r"D:\DataSet\0718_sketch\img"
...
def topath( image ) :
	image.save("D:/DataSet/0718_sketch/img/.imagetemp/gray_temp.jpg")
	return rootpath + r"\.imagetemp\gray_temp.jpg"
	
	

net_G = build_res_unet(n_input=1, n_output=2, size=256)
net_G.load_state_dict(torch.load(r"D:\DataSet\0718_sketch\img\res34-unet.pt", map_location=device))
